  ...
  return (
    <section className="w-full py-[100px]">
      <div className="mx-auto flex w-full max-w-7xl flex-col items-start justify-between gap-[64px] lg:flex-row">
        {/* Text Section */}
        <div className="flex w-full items-center max-w-[380px] pt-20 flex-col gap-[20px] px-4 sm:px-6 lg:max-w-[500px]">
          ...
          <BlurFade delay={0.25} inView>
            <p className="text-[18px] font-[400] leading-[30px] sm:text-[18px] sm:leading-[27px]">
            Few questions about SUPA
              </p>
