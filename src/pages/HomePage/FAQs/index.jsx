...
function FAQs() {
  return (
    <section className="w-full py-[100px]">
      <div className="mx-auto flex w-full flex-col items-start justify-between gap-[64px] lg:flex-row ">
        <div className="flex w-full max-w-[380px] flex-col gap-[20px]">
          <BlurFade delay={0.25} inView>
            <h1 className="text-[36px] font-[500] leading-[44px] text-[#1D2849] text-left">
              Some of the things you may have questions about
            </h1>
          </BlurFade>
          <BlurFade delay={0.25} inView>
            <p className="text-[18px] leading-[27px] text-[#808DB3]">
