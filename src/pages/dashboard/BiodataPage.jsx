...
// const BiodataPage = ({ user = { name: "John Doe", email: "john@example.com", phoneNumber: "1234567890", userType: "artisan" } }) => {
...
//                     <Input id="phoneNumber" type="tel" defaultValue={user.phoneNumber} required />
//                   </div>
//                   <div className="space-y-2">
//                     <Label htmlFor="userType">User Type</Label>
//                     <Select defaultValue={user.userType} disabled>
//                       <SelectTrigger id="userType">
//                         <SelectValue placeholder="Select user type" />
//                       </SelectTrigger>
//                       <SelectContent>
//                         <SelectItem value="artisan">Artisan</SelectItem>
//                         <SelectItem value="intendingArtisan">Intending Artisan</SelectItem>
