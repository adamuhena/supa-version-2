...
//     states.find((state) => replaceSymbolsWithSpace(`${state?.value}`) === replaceSymbolsWithSpace(`${filter?.stateOfResidence}`))
//       ?.lgas || []
...
//       // Initialize tradeArea as array if it doesn't exist
...
//               <Select value={filter?.stateOfResidence} onValueChange={(value) => handleFilterChange("state", value)}>
...
//               <Select value={filter.lgaOfResidence} onValueChange={(value) => handleFilterChange("lga", value)}>
//                 <SelectTrigger className="text-[12px]">
...
//                 State of Residence/LGA {filter.sort === "stateOfResidence" ? "↑" : filter.sort === "-stateOfResidence" ? "↓" : ""}
//               </TableHead>
...
//                 State of Origin/LGA {filter.sort === "stateOfOrigin" ? "↑" : filter.sort === "-stateOfOrigin" ? "↓" : ""}
//               </TableHead>
...
//                 Verification Status {filter.sort === "currentVerificationStatus" ? "↑" : filter.sort === "-currentVerificationStatus" ? "↓" : ""}
//               </TableHead>
...
//                                       value={editedUser.education?.eduUpload || ""}
//                                       onChange={(e) => handleInputChange("education.eduUpload", e.target.value)}
...
//                                             {cert.tradeArea && cert.tradeArea.length > 0 && (
