...
//       stateOfOrigin: "",
//       lga: "",
//       priorSkillsCerts: [], // Reset to an empty array
//       legalInfo: {
//         tradeAreas: [],
//       },
//     });
...
//   // Update the state of origin handler
//   const handleSubmit = async (e) => {
//     e.preventDefault();
//     setLoading(true);
//     setError(null);
...
//   return (
//     <section className="relative bg-slate-900 pt-40 pb-10 min-h-screen">
//       <div className="flex items-start justify-center absolute top-10 left-0 right-0 bottom-0">
//         <div className="flex w-full max-w-4xl bg-white shadow-lg rounded-lg overflow">
//           {/* Left image section */}
//           <div className="hidden md:block w-3/5 relative">
//             {signupAs === "artisan_user" ? (
//               <div className="flex h-full items-center justify-center bg-green-100 p-6">
...
//                         <SelectContent>
//                           <SelectGroup>
//                             {senatorialDistricts.map((senatorialDistricts) => (
//                               <SelectItem key={senatorialDistricts} value={senatorialDistricts}>
//                                 {senatorialDistricts}
//                               </SelectItem>
//                             ))}
//                           </SelectGroup>
...
//     } else if (signupAs !== "training_center" && (!isOnlyNumbers(formData.nin) || formData.nin.trim().length !== 11)) {
//       errorMsg = "NIN must be 11 numeric digits!"
//     } else if (formData.hasDisability && !formData.disabilityType) {
//       errorMsg = "Please select a type of disability!";
//     }
...
//                             Do you have a disability? <span className="text-red-600 ml-[4px] text-[13px]">*</span>
//                           </Label>
//                           <input
//                             type="checkbox"
//                             id="hasDisability"
...
//                         <Label className="text-left text-xs text-gray-600">Prior Skills/Certificates</Label>
//                         <Button
//                           type="button"
//                           variant="outline"
//                           size="sm"
...
//                     <div className="space-y-4">
//                       <Label className="text-left text-xs text-gray-600">Intending Skill</Label>
                ...
                Training Center
                  ...
                  <TabsContent className="overflow-y-auto" value="artisan_user">
                    <form onSubmit={handleSubmit} className="space-y-4">
                      ...
                      <div className="space-y-4">
                        <div className="flex justify-between items-center">
                          <Label className="text-left text-xs text-gray-600">Prior Skills/Certificates <span className="text-red-600 ml-[4px] text-[13px]">*</span></Label>
                          <Button
                            type="button"
                            variant="outline"
                            size="sm"
                  ...
                  <TabsContent value="intending_artisan">
                    <form onSubmit={handleSubmit} className="space-y-4">
                      ...
                      {/* Prior Skills Certificate - Single Entry for Intending Artisan */}
                      <div className="space-y-4">
                        <Label className="text-left text-xs text-gray-600">Intending Skill <span className="text-red-600 ml-[4px] text-[13px]">*</span></Label>
                        <div className="grid grid-cols-1 gap-4 p-4 border rounded-md">
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div className="space-y-2">
                              <Label htmlFor="prior-sector" className="text-left text-xs text-gray-600">
