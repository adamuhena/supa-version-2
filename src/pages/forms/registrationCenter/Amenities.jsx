  ...
  return (
    ...
    >
      ...
      <div className="flex items-center">
        ...
        <Select value={form.amenities?.portableWater} onValueChange={(value) => updateField("portableWater", value)}>
          <SelectTrigger className="w-[200px]">
            <SelectValue placeholder="Select" />
          </SelectTrigger>
          <SelectContent>
      ...
      <div className="flex items-center">
        ...
        <Select value={form.amenities?.observeBreak} onValueChange={(value) => updateField("observeBreak", value)}>
          <SelectTrigger className="w-[200px]">
            <SelectValue placeholder="Select" />
          </SelectTrigger>
          <SelectContent>
      ...
      {form.amenities?.observeBreak === "yes" && (
        <div className="flex items-center">
          <Label htmlFor="breakTime" className="w-[300px] text-left leading-[1.3]">
            What is the break time?
          </Label>
          <Input
            type="time"
            id="breakTime"
            value={form.amenities?.breakTime}
            onChange={(e) => updateField("breakTime", e.target.value)}
          />
        </div>
      )}
      ...
      <div className="flex items-start">
        ...
        <Textarea
          id="otherComments"
          placeholder="Enter any additional comments"
          value={form.amenities?.otherComments}
          onChange={(e) => updateField("otherComments", e.target.value)}
          className="min-h-[100px]"
        />
      </div>
