...
const CompanyInfo = ({ form, setForm, controlButtons }) => {
  ...
  return (
      ...
      >
        <h1 className="text-left font-[700] text-[24px]">Training Centre Profile</h1>
        ...
        <div className="flex items-center">
          <Label htmlFor="areaOffice" className="w-[300px] text-left leading-[1.3]">Area Office</Label>
          <Input
              id="areaOffice"
        ...
        <div className="flex items-center">
          <Label htmlFor="trainingCentreName" className="w-[300px] text-left leading-[1.3]">Name of Training Centre</Label>
          <Input
        ...
        <div className="flex items-center">
          <Label htmlFor="address" className="w-[300px] text-left leading-[1.3]">Address of Training Centre</Label>
          <Input
              id="address"
        ...
        <div className="flex items-center">
          <Label htmlFor="contactPerson" className="w-[300px] text-left leading-[1.3]">Name of Contact Person</Label>
          <Input
              id="contactPerson"
        ...
        <div className="flex items-center">
          <Label htmlFor="phoneNumber" className="w-[300px] text-left leading-[1.3]">Phone No./WhatsApp</Label>
          <Input
              id="phoneNumber"
        ...
        <div className="flex items-center">
          <Label htmlFor="email" className="w-[300px] text-left leading-[1.3]">E-Mail Address</Label>
          <Input
              id="email"
              type="email"
        ...
        <div className="flex items-center">
          <Label htmlFor="establishmentDate" className="w-[300px] text-left leading-[1.3]">Date of Establishment</Label>
          <Input
        ...
        <div className="flex items-center">
          <Label htmlFor="ownership" className="w-[300px] text-left leading-[1.3]">Ownership</Label>
          <Select
        ...
        {form.ownership === "other" && (
            <div className="flex items-center">
              <Label htmlFor="otherOwnership" className="w-[300px] text-left leading-[1.3]">Specify Other Ownership</Label>
              <Input
                  id="otherOwnership"
        ...
        <div className="flex items-center">
          <Label htmlFor="trainingNature" className="w-[300px] text-left leading-[1.3]">Nature of Training</Label>
          <Select
        ...
        <div className="flex items-center">
          <Label htmlFor="itfRegistered" className="w-[300px] text-left leading-[1.3]">Is the Centre registered with ITF?</Label>
          <Select
        ...
        {form.itfRegistered === "yes" && (
            <div className="flex items-center">
              <Label htmlFor="itfRegistrationNumber" className="w-[300px] text-left leading-[1.3]">ITF Registration Number</Label>
              <Input
                  id="itfRegistrationNumber"
                  placeholder="Enter ITF Registration Number"
                  value={form.itfRegistrationNumber}
                  onChange={(e) => updateField("itfRegistrationNumber", e.target.value)}
              />
            </div>
        )}
